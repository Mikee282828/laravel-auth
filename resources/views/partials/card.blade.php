			...
			<div class="col-4 mt-3">
				<div class="card p-0 h-100">
					<div class="row g-0 m-0">
						<div class="col-12">
							<img src="{{ $projectSingle->img_preview }}" class="w-50 rounded-start" alt="...">
						</div>
						<h5 class="card-title"><b>Titolo:</b> {{ $projectSingle->title }}</h5>
					</div>
					<a href="{{ route('admin.projects.show', $projectSingle->id) }}" class="btn btn-outline-primary my-3">Clicca per
						Dettagli</a>
